...
wget -q -O /usr/local/bin/edu-ssh https://raw.githubusercontent.com/myridwan/sc2/ipuk/proxy-template.py
chmod +x /usr/local/bin/edu-ssh

# Installing Service
cat > /etc/systemd/system/edussh-nontls.service << END
[Unit]
Description=Ssh Websocket By XDRG Vpn Store
Documentation=https://t.me/r1f4n_112
...
wget -q -O /usr/local/bin/edu-ovpn https://raw.githubusercontent.com/myridwan/sc2/ipuk/edu-op.py
...
[Unit]
Description=Ovpn Websocket By XDRG Vpn Store
Documentation=https://t.me/r1f4n_112
After=network.target nss-lookup.target
...
echo -e "==============================="
echo -e "Script By XDRG Vpn Store"
