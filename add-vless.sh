...
vlesslink1="vless://${uuid}@${domain}:$tls?path=/XDRG&security=tls&encryption=none&type=ws#${user}"
vlesslink2="vless://${uuid}@${domain}:$none?path=/XDRG&encryption=none&type=ws#${user}"
