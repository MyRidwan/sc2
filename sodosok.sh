#!/bin/bash
#shadowsocks-libev obfs install by Mardhex
...
cd /usr/bin
wget -O add-ss "https://raw.githubusercontent.com/myridwan/sc2/ipuk/add-ss.sh"
wget -O del-ss "https://raw.githubusercontent.com/myridwan/sc2/ipuk/del-ss.sh"
wget -O cek-ss "https://raw.githubusercontent.com/myridwan/sc2/ipuk/cek-ss.sh"
wget -O renew-ss "https://raw.githubusercontent.com/myridwan/sc2/ipuk/renew-ss.sh"
chmod +x add-ss
chmod +x del-ss
chmod +x cek-ss
chmod +x renew-ss
